package com.example.one.config.filter;
...
/**
 * @author LiuJiangFeng
 * @ClassName: BookFilter
 * @Date 2018/9/25 10:16
 */
//@WebFilter(filterName = "BookFilter",urlPatterns = "/*")
public class BookFilter implements Filter {
    ...
    private String failPage = "/templates/error.html";//发生注入时，跳转页面
